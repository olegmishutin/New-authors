...
class Book(models.Model):
    ...
    categories = models.ManyToManyField(
        Category, db_table="BookCategories", verbose_name="Категории"
    )
    ...
    reviews = models.ManyToManyField(
        User, related_name="books_reviews", through="Review", verbose_name="Отзывы"
    )
    ...
    def getRating(self):
        return round(
            self.review_set.all()
            .aggregate(rating=Avg("rating", default=0))
            .get("rating"),
            1,
        )
